          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Shop Master</h3>
              </div>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h5 class="modal-title" id="modal-add-label">Add Shop Master</h5>
                                ...
                                <form action="{{ url('/mst/shop/store') }}" method="POST">
                                  ...
                                  <div class="modal-body">
                                    ...
                                    <select name="shop" id="shop" class="form-control" required>
                                        ...
                                        @foreach ($dropdownShop as $dropdown)
                          ...
                          <div class="modal-content">
                            ...
                            <form action="{{ url('/mst/shop/update/'.$data->id) }}" method="POST">
                              ...
                              <div class="modal-body">
                                <div class="form-group">
                                <select name="shop" id="shop" class="form-control" required>
                                    <option value="{{$data->shop}}">{{$data->shop}}</option>
                                    @foreach ($dropdownShop as $dropdown)
                                        <option value="{{ $dropdown->name_value }}">{{ $dropdown->name_value }}</option>
                                    @endforeach
                                </select>
